...
c+="?callback="+encodeURIComponent(f);c+="&"+e;e=document.createElement("script");e.src=c;c=document.getElementsByTagName("head")[0]||document.documentElement;c.insertBefore(e,c.firstChild);setTimeout(function(){d||b()},1E4)}});Socky.PresenceChannel=Socky.PrivateChannel.extend({init:function(a,b,c){this._super(a,b,c);this._members={};this.raw_event_bind("socky:member:added",Socky.Utils.bind(this.on_member_added,this));this.raw_event_bind("socky:member:removed",Socky.Utils.bind(this.on_member_removed,
